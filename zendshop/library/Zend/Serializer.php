...
class Zend_Serializer
{
    ...
    /**
     * Returns a Low adapter plugin loader
     *
     * @return Zend_Loader_PluginLoader
     */
    ...
    /**
     * Generates a storable representation of a value using the Low adapter.
     *
     * @param mixed $value
     * @param array $options
     * @return string
    ...
    /**
     * Creates a PHP value from a stored representation using the Low adapter.
     *
