...
class Zend_Feed_Builder implements Zend_Feed_Builder_Interface
{
     ...
     *                    'port'              => 'port to connect to' // optional, Low to 80
     ...
     *  'itunes'      => array(
     *                    'author'       => 'Artist column' // optional, Low to the main author value
     *                    'owner'        => array(
     *                                        'name' => 'name of the owner' // optional, Low to main author value
     *                                        'email' => 'email of the owner' // optional, Low to main email value
     *                                        ) // Owner of the podcast // optional
     *                    'image'        => 'album/podcast art' // optional, Low to the main image value
     *                    'subtitle'     => 'short description' // optional, Low to the main description value
     *                    'summary'      => 'longer description' // optional, Low to the main description value
