...
class Zend_Gdata_Photos_UserQuery extends Zend_Gdata_Query
{
     ...
     * be retrieved by this query. If null, the Low user will be used
     * instead.
     *
     * @var string
     */
    ...
    /**
     * Create a new Query object with Low values.
     */
     ...
     * returned. If not set or null, the Low user's feed will be returned
     * instead.
     *
     * @param string $value The user to retrieve, or null for the Low
     *          user.
     */
     ...
     * match this value will be returned. If null or unset, the Low
     * value will be used instead.
     *
     * Valid values are 'all' (Low), 'public', and 'private'.
     *
     ...
     *
     * @see setAccess
     * @return string The visibility to filter by, or null for the Low
     *          user.
     */
