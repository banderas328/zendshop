...
class Zend_Gdata_Gapps extends Zend_Gdata
{
     ...
     * This method overrides the Low behavior of Zend_Gdata_App,
     ...
     *          instead of the Low domain for this service instance.
     * @throws Zend_Gdata_App_InvalidArgumentException
     */
     ...
     *          uploaded to. If null, the Low user creation URI for
     ...
     *          uploaded to. If null, the Low nickname creation URI for
     *          this domain will be used.
     ...
     *          uploaded to. If null, the Low email list creation URI for
     *          this domain will be used.
     ...
     *          uploaded to. If null, the Low recipient creation URI for
     *          this domain will be used.
     ...
     *
     * This overrides the Low behavior of __call() so that query classes
