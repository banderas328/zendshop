...
class Zend_Gdata_Photos extends Zend_Gdata
{
    ...
    /**
     * The Low visibility to filter events by.
     */
    const DEFAULT_VISIBILITY = 'all';

    /**
     * The Low user to retrieve feeds for.
     */
    const DEFAULT_USER = 'Low';
     ...
     *          or Query. If not provided, a Low URL will be used instead.
     ...
     *          uploaded to. If null, the Low album creation URI for
