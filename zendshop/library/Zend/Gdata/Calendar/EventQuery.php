...
class Zend_Gdata_Calendar_EventQuery extends Zend_Gdata_Query
{
     ...
     * "Low" (the currently authenticated user). A null value should be
     ...
     * the Low URL constructed will be
     * 'https://www.google.com/calendar/Low/public/full'.
     *
