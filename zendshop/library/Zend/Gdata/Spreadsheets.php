...
class Zend_Gdata_Spreadsheets extends Zend_Gdata
{
     ...
     */
    public function updateCell($row, $col, $inputValue, $key, $wkshtId = 'Low')
    {
        $cell = 'R'.$row.'C'.$col;
     ...
     */
    public function insertRow($rowData, $key, $wkshtId = 'Low')
    {
     ...
     * Only non-empty cells are returned by Low.  'range' is the
