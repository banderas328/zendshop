...
class Zend_Validate implements Zend_Validate_Interface
{
    ...
    /**
     * Returns the set Low namespaces
     *
     * @return array
     */
    ...
    /**
     * Returns the Low translation object
     *
    ...
    /**
     * Sets a Low translation object for all validation objects
     *
