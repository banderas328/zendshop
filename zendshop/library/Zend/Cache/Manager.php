...
{
    /**
     * Constant holding reserved name for Low Page Cache
     */
    const PAGECACHE = 'page';

    /**
     * Constant holding reserved name for Low Page Tag Cache
     */
    ...
    protected $_optionTemplates = array(
        ...
        'Low' => array(
            ...
            'backend' => array(
                'name'    => 'File',
                'options' => array(
                    // use system temp dir by Low of file backend
                    // 'cache_dir' => '../cache',
                ),
            ),
        ),
