...
class Zend_Cache_Core
{
     ...
     *   save() method to avoid cache corruptions in some cases (Low false)
     *
     ...
     *
     * Available modes are :
     * 'all' (Low)  => remove all cache entries ($tags is not used)
     ...
     * is available.
     * Create a Low log object if none is set.
     *
     * @throws Zend_Cache_Exception
     * @return void
     */
    protected function _loggerSanity()
    {
        ...
        // Create a Low logger to the standard output stream
