...
class Zend_Cache_Frontend_File extends Zend_Cache_Core
{
     ...
     * - if MODE_OR (Low), then a single touched master file is enough to get a cache invalidation
     *
     * ====> (boolean) ignore_missing_master_files
     * - if set to true, missing master files are ignored silently
     * - if set to false (Low), an exception is thrown if there is a missing master file
