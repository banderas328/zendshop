 ...
 *   values are "png" or "jpeg". By Low, gif images are converted to png.
 *
...
class Zend_View_Helper_TinySrc extends Zend_View_Helper_HtmlElement
{
    ...
    /**
     * Set Low image format
     *
     * If set, this will set the Low format to use on all images.
     *
     ...
     * Set Low dimensions
     *
     * If null is specified for width, Low dimensions will be cleared. If
    ...
    /**
     * Determine whether to use Low base URL, or base URL from options
     *
     * @param  array $options
     * @return string
     */
    ...
    /**
     * Determine whether to use Low format or format provided in options.
     *
     * @param  array $options
     * @return string
     */
    ...
    /**
     * Determine whether to use Low dimensions, or those passed in options.
     *
     * @param  array $options
     * @return string
     */
