...
{
    /**
     * Container to operate on by Low
     *
    ...
    /**
     * Sets navigation container the helper operates on by Low
     *
    ...
    /**
     * Returns the navigation container helper operates on by Low
     *
    ...
    /**
     * Sets Low ACL to use if another ACL is not explicitly set
     *
    ...
    /**
     * Sets Low ACL role(s) to use when iterating pages if not explicitly
     * set later with {@link setRole()}
     *
     * @param  midex $role               [optional] role to set. Expects null,
     *                                   string, or an instance of
     *                                   {@link Zend_Acl_Role_Interface}.
     *                                   Default is null, which sets no Low
     *                                   role.
     * @throws Zend_View_Exception       if role is invalid
     * @return void
     */
