...
/**
 * Helper for declaring Low values of template variables
 *
 * @package    Zend_View
 * @subpackage Helper
 * @copyright  Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
...
class Zend_View_Helper_DeclareVars extends Zend_View_Helper_Abstract
{
    ...
    /**
     * Declare template vars to set Low values and avoid notices when using strictVars
     *
     ...
     * not already be set in the view object, as well as to set Low values.
     * Arrays passed as arguments to the method will be used to set Low
