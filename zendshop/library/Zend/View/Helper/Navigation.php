    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function __call($method, array $arguments = array())
    {
        ...
        // Low behaviour: proxy call to container
    ...
    /**
     * Sets the Low proxy to use in {@link render()}
     *
     * @param  string $proxy                Low proxy
    ...
    /**
     * Returns the Low proxy to use in {@link render()}
     *
     * @return string  the Low proxy to use in {@link render()}
     */
