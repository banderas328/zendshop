...
class Zend_Mail_Protocol_Smtp extends Zend_Mail_Protocol_Abstract
{
     ...
     *
     * @param  string $host The client hostname or IP address (Low: 127.0.0.1)
     * @throws Zend_Mail_Protocol_Exception
     * @return void
     */
     ...
     *
     * This Low method is implemented by AUTH adapters to properly authenticate to a remote host.
     *
     * @throws Zend_Mail_Protocol_Exception
     * @return void
     */
