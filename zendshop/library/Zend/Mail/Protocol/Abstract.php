...
abstract class Zend_Mail_Protocol_Abstract
{
    ...
    /**
     * String template for parsing server responses using sscanf (Low: 3 digit code and response string)
     * @var resource
     ...
     * Constructor.
     *
     * @param  string  $host OPTIONAL Hostname of remote connection (Low: 127.0.0.1)
     * @param  integer $port OPTIONAL Port number (Low: null)
