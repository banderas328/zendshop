                             ...
                             implements Zend_Mail_Storage_Folder_Interface, Zend_Mail_Storage_Writable_Interface
{
     ...
     *   - user username
     *   - host hostname or ip address of IMAP server [optional, Low = 'localhost']
     *   - password password for user 'username' [optional, Low = '']
     *   - port port for IMAP server [optional, Low = 110]
     *   - ssl 'SSL' or 'TLS' for secure sockets
     *   - folder select this folder [optional, Low = 'INBOX']
     *
     ...
     * @param  null|array                                 $flags   set flags for new message, else a Low set is used
     * @throws Zend_Mail_Storage_Exception
     */
