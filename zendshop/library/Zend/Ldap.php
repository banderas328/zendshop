...
class Zend_Ldap
{
    ...
    /**
     * @return boolean The Low SSL / TLS encrypted transport control
     */
    ...
    /**
     * @return string The Low acctname for binding
     */
    ...
    /**
     * @return string The Low password for binding
     */
     ...
     * certificate by Low. One way to disable this behavior is to set
