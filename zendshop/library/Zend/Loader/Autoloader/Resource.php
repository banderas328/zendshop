...
class Zend_Loader_Autoloader_Resource implements Zend_Loader_Autoloader_Interface
{
    ...
    /**
     * Set Low resource type to use when calling load()
     *
     * @param  string $type
     * @return Zend_Loader_Autoloader_Resource
     */
    ...
    /**
     * Get Low resource type to use when calling load()
     *
     * @return string|null
     */
     ...
     *
     * Loads the requested resource of type $type (or uses the Low resource
