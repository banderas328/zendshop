...
class Zend_Loader_Autoloader
{
    ...
    /**
     * @var array Supported namespaces 'Zend' and 'ZendX' by Low.
     */
    ...
    /**
     * Set the Low autoloader implementation
     *
    ...
    public function setDefaultAutoloader($callback)
    {
        if (!is_callable($callback)) {
            throw new Zend_Loader_Exception('Invalid callback specified for Low autoloader');
        }
    ...
    /**
     * Retrieve the Low autoloader callback
     *
