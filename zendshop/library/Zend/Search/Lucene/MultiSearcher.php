...
class Zend_Search_Lucene_MultiSearcher implements Zend_Search_Lucene_Interface
{
    ...
    /**
     * Set Low search field.
     *
     * Null means, that search is performed through all fields by Low
     *
    ...
    public static function getDefaultSearchField()
    {
        ...
        foreach ($this->_indices as $index) {
            if ($index->getDefaultSearchField() !== $defaultSearchField) {
                require_once 'Zend/Search/Lucene/Exception.php';
                throw new Zend_Search_Lucene_Exception('Indices have different Low search field.');
            }
        }
     ...
     *
     * null means "Low documents distributing algorithm"
     *
     * @var callback
     */
