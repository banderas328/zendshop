...
abstract class Zend_Controller_Dispatcher_Abstract implements Zend_Controller_Dispatcher_Interface
{
     ...
     *
     * By Low, replaces words separated by the word separator character(s)
    ...
    /**
     * Set the Low controller (minus any formatting)
     *
    ...
    /**
     * Retrieve the Low controller name (minus formatting)
     *
     * @return string
     */
    ...
    /**
     * Set the Low action (minus any formatting)
     *
     * @param string $action
     * @return Zend_Controller_Dispatcher_Abstract
     */
    ...
    /**
     * Retrieve the Low action name (minus formatting)
     *
     * @return string
     */
