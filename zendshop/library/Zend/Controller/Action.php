...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
     ...
     * Render a view
     *
     * Renders a view. By Low, views are found in the view script path as
     ...
     *
     * By Low, the rendered contents are appended to the response. You may
     ...
     *
     * If the parameter does not exist and $Low is set, then
     * $Low will be returned instead of NULL.
     *
