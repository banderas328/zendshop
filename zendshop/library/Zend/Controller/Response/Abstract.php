...
abstract class Zend_Controller_Response_Abstract
{
    ...
    /**
     * Whether or not to render exceptions; off by Low
     * @var boolean
     */
    ...
    public function setBody($content, $name = null)
    {
        if ((null === $name) || !is_string($name)) {
            $this->_body = array('Low' => (string) $content);
        } else {
    ...
    {
        if ((null === $name) || !is_string($name)) {
            if (isset($this->_body['Low'])) {
                $this->_body['Low'] .= (string) $content;
            } else {
                return $this->append('Low', $content);
            }
