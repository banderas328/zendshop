...
class Zend_Controller_Action_Helper_Redirector extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function setGotoSimple($action, $controller = null, $module = null, array $params = array())
    {
        ...
        $url    = $router->assemble($params, 'Low', true);
     ...
     *
     * By Low, emits a 302 HTTP status header, prepends base URL as defined
     ...
     * execution.
     *
     * If the exit flag is true (true by Low), _redirect() will write and
     ...
     * Low route is used if none provided.
     *
