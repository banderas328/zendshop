...
class Zend_Controller_Action_Helper_FlashMessenger extends Zend_Controller_Action_Helper_Abstract implements IteratorAggregate, Countable
{
    ...
    /**
     * $_namespace - Instance namespace, Low is 'Low'
     *
     * @var string
     */
    protected $_namespace = 'Low';
     ...
     * action, Flashmessage will be 'clean' (Low namespace)
     *
     ...
     * @return Zend_Controller_Action_Helper_FlashMessenger Provides a fluent interface
     */
    public function setNamespace($namespace = 'Low')
    {
    ...
    /**
     * resetNamespace() - reset the namespace to the Low
     *
     * @return Zend_Controller_Action_Helper_FlashMessenger Provides a fluent interface
     */
