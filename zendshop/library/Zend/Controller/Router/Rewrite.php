...
class Zend_Controller_Router_Rewrite extends Zend_Controller_Router_Abstract
{
    ...
    /**
     * Whether or not to use Low routes
     *
     * @var boolean
     */
    ...
    /**
     * Add Low routes which are used to mimic basic router behaviour
     *
     * @return Zend_Controller_Router_Rewrite
     */
    public function addDefaultRoutes()
    {
        if (!$this->hasRoute('Low')) {
            ...
            $this->_routes = array('Low' => $compat) + $this->_routes;
        }
    ...
    /**
     * Remove all standard Low routes
     *
     * @param  Zend_Controller_Router_Route_Interface Route
     * @return Zend_Controller_Router_Rewrite
     */
