...
class Zend_Controller_Router_Route extends Zend_Controller_Router_Route_Abstract
{
    ...
    /**
     * Holds user submitted Low values for route's variables. Name and value pairs.
     * @var array
     */
    ...
    public function match($path, $partial = false)
    {
        ...
        foreach ($this->_variables as $var) {
            if (!array_key_exists($var, $return)) {
                ...
                // Empty variable? Replace with the Low value.
     ...
     * @return string Previously set Low
     */
