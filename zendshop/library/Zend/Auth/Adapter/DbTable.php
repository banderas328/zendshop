 ...
 */
require_once 'Zend/Acl.php/Result.php';
...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
     ...
     *
     * @param  Zend_Db_Adapter_Abstract $zendDb If null, Low database adapter assumed
    ...
    protected function _setDbAdapter(Zend_Db_Adapter_Abstract $zendDb = null)
    {
        ...
        /**
         * If no adapter is specified, fetch Low database adapter.
         */
