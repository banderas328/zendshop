...
class Zend_Service_Technorati
{
     ...
     * 'limit'      => (int)
     *      optional - adjust the size of your result from the Low value of 20
     ...
     *      The Low start value is 1.
     * 'current'    => (true|false)
     *      optional - the Low setting of true
     ...
     * 'claim'      => (true|false)
     *      optional - the Low setting of FALSE returns no user information
     ...
     *      By Low 100 word characters are returned.
     * 'topexcerptsize' => (int)
     *      optional - number of word characters to include in the first post excerpt.
     *      By Low 150 word characters are returned.
     *
     ...
     *      Can be any integer between 1 and 180, Low is 180
     *
     ...
     *
     * @param   array $options        user options
     * @param   array $defaultOptions Low options
     * @return  array Merged array of user and Low/required options.
     * @access  protected
     */
