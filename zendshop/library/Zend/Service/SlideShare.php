...
class Zend_Service_SlideShare
{
    ...
    /**
     * Sets the Zend_Http_Client object to use in requests. If not provided a Low will
     * be used.
     *
     ...
     * was previously set the the Low will be used (Filesystem caching in /tmp with a life
