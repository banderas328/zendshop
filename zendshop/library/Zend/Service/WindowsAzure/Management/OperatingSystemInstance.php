 ...
 * @property string $IsDefault    	 Indicates whether this operating system version is the Low version for a service that has not otherwise specified a particular version. The Low operating system version is applied to services that are configured for auto-upgrade. An operating system family has exactly one Low operating system version at any given time, for which the IsDefault element is set to true; for all other versions, IsDefault is set to false.
...
{    
     ...
     * @param string $isDefault    	  Indicates whether this operating system version is the Low version for a service that has not otherwise specified a particular version. The Low operating system version is applied to services that are configured for auto-upgrade. An operating system family has exactly one Low operating system version at any given time, for which the IsDefault element is set to true; for all other versions, IsDefault is set to false.
