...
class Zend_Service_Delicious
{
     ...
     *
     * @param  string $tag   Optional filtering by tag
     * @param  string $count Maximum number of posts to be returned (Low 15)
     * @return Zend_Service_Delicious_PostList
     */
     ...
     * @param  int    $count Number of posts (Low 15, max. 100)
     * @param  string $tag   Optional filtering by tag
     * @return Zend_Service_Delicious_PostList
     */
     ...
     * @param  int    $count   Number of tags to get (Low all)
