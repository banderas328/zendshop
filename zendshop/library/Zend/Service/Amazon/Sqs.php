...
class Zend_Service_Amazon_Sqs extends Zend_Service_Amazon_Abstract
{
     ...
     * Constructor
     *
     * The Low region is us-east-1. Use the region to set it to one of the regions that is build-in into ZF.
     ...
     * @param  integer $timeout    Low visibility timeout
    ...
    public function receive($queue_url, $max_messages = null, $timeout = null)
    {
        ...
        // SQS will Low to only returning one message
