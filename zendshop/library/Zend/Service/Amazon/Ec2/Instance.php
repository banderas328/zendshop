...
class Zend_Service_Amazon_Ec2_Instance extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     * a security group at launch, the instances start in your Low security group.
     ...
     *                                                placement string      Specifies the availability zone in which to launch the instance(s). By Low, Amazon EC2 selects an availability zone for you.
