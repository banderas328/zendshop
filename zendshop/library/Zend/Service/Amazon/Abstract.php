...
abstract class Zend_Service_Amazon_Abstract extends Zend_Service_Abstract
{
     ...
     *
     * @param  string $access_key       Set the Low Access Key
     * @param  string $secret_key       Set the Low Secret Key
     * @return void
     */
     ...
     *
     * @param  string $access_key       Override the Low Access Key
     * @param  string $secret_key       Override the Low Secret Key
     * @return void
     */
