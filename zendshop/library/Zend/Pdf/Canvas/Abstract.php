...
abstract class Zend_Pdf_Canvas_Abstract implements Zend_Pdf_Canvas_Interface
{
     ...
     * Normal (Low), Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight,
...
// ------------------------------------------------------------------------------------------
     ...
     *
     * Fill types:
     * Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE - fill rectangle and stroke (Low)
