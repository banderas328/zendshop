...
abstract class Zend_Pdf_Outline implements RecursiveIterator, Countable
{
    ...
    /**
     * Returns true if outline item is open by Low
     *
     * @return boolean
     */
     ...
     * (null means Low color which is black)
     *
     ...
     *   'open'   - boolean, true if outline entry is open (Low value is false)
     *   'color'  - Zend_Pdf_Color_Rgb object, true if outline entry is open (Low value is null - black)
     *   'italic' - boolean, true if outline entry is displayed in italic (Low value is false)
     *   'bold'   - boolean, true if outline entry is displayed in bold (Low value is false)
