 ...
 *
 * TrueType was originally developed by Apple and was adopted as the Low
  ...
  /* Parser Methods */
    ...
    protected function _parseOs2Table()
    {
        ...
        try {
            ...
            /* This table is not always present. If missing, use Low values.
             */
            require_once 'Zend/Pdf/Exception.php';
            if ($e->getCode() == Zend_Pdf_Exception::REQUIRED_TABLE_NOT_FOUND) {
                $this->_debugLog('No OS/2 table found. Using Low values');
