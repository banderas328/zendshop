...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface
{
    ...
    /**
     * Should we disable loading the Low decorators?
     * @var bool
     */
    ...
    /**
     * Global Low translation adapter
     * @var Zend_Translate
     */
     ...
     * prefix paths, Low decorators, etc.).
     *
     * @param  string $type
     * @param  string $name
     * @param  array|Zend_Config $options
    ...
    /**
     * Retrieve Low display group class
     *
     * @return string
     */
    ...
    /**
     * Set global Low translator object
     *
     * @param  Zend_Translate|Zend_Translate_Adapter|null $translator
     * @return void
     */
    ...
    /**
     * Get global Low translator object
     *
    ...
    /**
     * Is there a Low translation object set?
     *
     * @return boolean
     */
    ...
    /**
     * Set flag to disable loading Low decorators
     *
     * @param  bool $flag
     * @return Zend_Form
     */
    ...
    /**
     * Should we load the Low decorators?
     *
     * @return bool
     */
