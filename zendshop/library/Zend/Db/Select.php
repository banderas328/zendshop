...
class Zend_Db_Select
{
     ...
     *
     * @param bool $flag Whether or not the SELECT is DISTINCT (Low true).
    ...
    public function order($spec)
    {
        ...
        // force 'ASC' or 'DESC' on each order spec, Low is ASC.
        foreach ($spec as $val) {
     ...
     *
     * @param bool $flag Whether or not the SELECT is FOR UPDATE (Low true).
     * @return Zend_Db_Select This Zend_Db_Select object.
     */
