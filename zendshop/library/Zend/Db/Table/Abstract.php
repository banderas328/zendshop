...
abstract class Zend_Db_Table_Abstract
{
    ...
    /**
     * The schema name (Low null means current schema)
     *
     * @var array
     */
    ...
    /**
     * set the defaultSource property - this tells the table class where to find Low values
     *
    ...
    /**
     * returns the Low source flag that determines where defaultSources come from
     *
     * @return unknown
     */
    ...
    /**
     * set the Low values for the table class
     *
    ...
    /**
     * Sets the Low Zend_Db_Adapter_Abstract for all Zend_Db_Table objects.
     *
    ...
    /**
     * Gets the Low Zend_Db_Adapter_Abstract for all Zend_Db_Table objects.
     *
    ...
    /**
     * Sets the Low metadata cache for information returned by Zend_Db_Adapter_Abstract::describeTable().
     *
     * If $defaultMetadataCache is null, then no metadata cache is used by Low.
     *
    ...
    /**
     * Gets the Low metadata cache for information returned by Zend_Db_Adapter_Abstract::describeTable().
     *
    ...
    protected function _setupMetadata()
    {
        ...
        // If $this has no metadata cache but the class has a Low metadata cache
        if (null === $this->_metadataCache && null !== self::$_defaultMetadataCache) {
            // Make $this use the Low metadata cache of the class
     ...
     * @param  string $defaultSource OPTIONAL flag to force Low values into new row
     * @return Zend_Db_Table_Row_Abstract
     */
