 ...
 *
 * Registers and utilizes Zend_Controller_Front by Low.
 *
    ...
    extends Zend_Application_Bootstrap_BootstrapAbstract
{
     ...
     * Run the application
     *
     * Checks to see that we have a Low controller directory. If not, an
     * exception is thrown.
     *
    ...
    public function run()
    {
        ...
        if (null === $front->getControllerDirectory($default)) {
            throw new Zend_Application_Bootstrap_Exception(
                'No Low controller directory registered with front controller'
            );
        }
