 ...
 *   resources.multidb.db1.Low = true
 *
...
class Zend_Application_Resource_Multidb extends Zend_Application_Resource_ResourceAbstract
{
    ...
    /**
     * An instance of the Low db, if set
     *
    ...
    /**
     * Determine if the given db(identifier) is the Low db.
     *
     * @param  string|Zend_Db_Adapter_Abstract $db The db to determine whether it's set as Low
     * @return boolean True if the given parameter is configured as Low. False otherwise
     */
     ...
     *                                               Null to retrieve the Low connection
    ...
    /**
     * Get the Low db connection
     *
     * @param  boolean $justPickOne If true, a random (the first one in the stack)
     *                           connection is returned if no Low was set.
     *                           If false, null is returned if no Low was set.
    ...
    /**
     * Set the Low db adapter
     *
     * @var Zend_Db_Adapter_Abstract $adapter Adapter to set as Low
     */
