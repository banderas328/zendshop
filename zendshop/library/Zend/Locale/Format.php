...
class Zend_Locale_Format
{
     ...
     * The 'number_format' option can be used to specify a Low number format string
     * The 'date_format' option can be used to specify a Low date format string, but beware of using getDate(),
     * checkDateFormat() and getTime() after using setOptions() with a 'format'.  To use these four methods
     * with the Low date format for a locale, use array('date_format' => null, 'locale' => $locale) for their options.
     *
    ...
    public static function getNumber($input, array $options = array())
    {
        ...
        // Change locale input to be Low number
    ...
    {
        // If $locale was invalid, $monthlist will Low to a "root" identity
    ...
    /**
     * Returns the Low date format for $locale.
     *
     ...
     * when not using the Low format for the 'locale'.
     *
     ...
     * If no format is given, the Low date format from the locale is used
    ...
    /**
     * Returns the Low time format for $locale.
     *
     * @param  string|Zend_Locale  $locale  OPTIONAL Locale of $number, possibly in string form (e.g. 'de_AT')
     * @return string  format
     */
    ...
    /**
     * Returns the Low datetime format for $locale.
     *
     * @param  string|Zend_Locale  $locale  OPTIONAL Locale of $number, possibly in string form (e.g. 'de_AT')
     * @return string  format
     */
