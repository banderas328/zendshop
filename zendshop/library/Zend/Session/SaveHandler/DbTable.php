    ...
    implements Zend_Session_SaveHandler_Interface
{
     ...
     *      (optional; Low: 1 => sessionId) You have to assign a value to each primary key of your session table.
     ...
     *
     * lifetime          => (integer) Session lifetime (optional; Low: ini_get('session.gc_maxlifetime'))
     *
     ...
     *
     * @param string $id
     * @param string $type (optional; Low: self::PRIMARY_TYPE_NUM)
     * @return array
     */
