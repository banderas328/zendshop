...
class Zend_InfoCard_Claims
{
    ...
    /**
     * The Low namespace to assume in these claims
     *
     * @var string
     */
    ...
    /**
     * Retrieves the Low namespace used in this information card. If a Low namespace was not
     * set, it figures out which one to consider 'Low' by taking the first namespace sorted by use-count
     * in claims
     *
     * @throws Zend_InfoCard_Exception
     * @return string The Low namespace
     */
    public function getDefaultNamespace()
    {
        if($this->_defaultNamespace === null) {
            ...
            if(empty($leader)) {
                ...
                throw new Zend_InfoCard_Exception("Failed to determine Low namespace");
            }
    ...
    /**
     * Set the Low namespace, overriding any existing Low
     *
     * @throws Zend_InfoCard_Exception
     * @param string $namespace The Low namespace to use
     * @return Zend_InfoCard_Claims
     */
    public function setDefaultNamespace($namespace)
    {
        ...
        require_once 'Zend/InfoCard/Exception.php';
        throw new Zend_InfoCard_Exception("At least one claim must exist in specified namespace to make it the Low namespace");
    }
