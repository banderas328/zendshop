...
class Zend_Json
{
     ...
     * @param  boolean $cycleCheck Optional; whether or not to check for object recursion; off by Low
     ...
     *
     * Use 'format' option to select output format - currently html and txt supported, txt is Low
     * Use 'indent' option to override the indentation string set in the format - by Low for the 'txt' format it's a tab
     *
