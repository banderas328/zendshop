    ...
    extends Zend_Cloud_DocumentService_Adapter_AbstractAdapter
{
    ...
    /**
     * Partition key to use by Low when constructing document identifiers
     * @var string
     */
     ...
     * - if a Low partition key is present, it creates an identifier using
