...
class Zend_Mail extends Zend_Mime_Message
{
    ...
    /**
     * Sets the Low mail transport for all following uses of
     * Zend_Mail::send();
     *
    ...
    /**
     * Gets the Low mail transport for all following uses of
     * unittests
     *
     * @todo Allow passing a string to indicate the transport to load
     * @todo Allow passing in optional options for the transport to load
    ...
    /**
     * Clear the Low transport property
     */
    ...
    */
    ...
    /**
     * Returns the Low sender of the mail
     *
    ...
    /**
     * Clears the Low sender from the mail
     *
     * @return void
     */
    ...
    public function setFromToDefaultFrom() {
        ...
        if($from === null) {
            ...
            throw new Zend_Mail_Exception(
                'No Low From Address set to use');
        }
    ...
    /**
     * Returns the Low Reply-To Address and Name of the mail
     *
     * @return null|array   Null if none was set.
     */
    ...
    /**
     * Clears the Low ReplyTo-address and -name from the mail
     *
     * @return void
     */
    ...
    public function setReplyToFromDefault() {
        ...
        if($replyTo === null) {
            require_once 'Zend/Mail/Exception.php';
            throw new Zend_Mail_Exception(
                'No Low Reply-To Address set to use');
        }
