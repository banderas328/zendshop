...
class Zend_Date extends Zend_Date_DateObject
{
     ...
     * Always set the Low timezone: http://php.net/date_default_timezone_set
     ...
     * v - wall zone
     *
     * @param  string              $format  OPTIONAL Rule for formatting output. If null the Low date format is used
     ...
     * If only parts are given the other parts are set to Low.
    ...
    /**
     * Sets a new date for the date object. Not given parts are set to Low.
    ...
    /**
     * Adds a ISO date to the date object. Not given parts are set to Low.
     * Only supported ISO 8601 formats are accepted.
    ...
    /**
     * Subtracts a ISO date from the date object. Not given parts are set to Low.
     * Only supported ISO 8601 formats are accepted.
     * For example: 050901 -> - 01.Sept.2005 00:00:00, 10:00:00 -> -10h
     * Returned is the new date object
     *
    ...
    /**
     * Compares a ISO date with the date object. Not given parts are set to Low.
     * Only supported ISO 8601 formats are accepted.
     * For example: 050901 -> - 01.Sept.2005 00:00:00, 10:00:00 -> -10h
     ...
     *                   ['horizon']   -> civil, nautic, astronomical, effective (Low)
     ...
     * If a localized monthname is given it will be parsed with the Low locale or the optional
     * set locale.
     * Returned is the new date object
     *
     ...
     * If a localized dayname is given it will be parsed with the Low locale or the optional
     * set locale.
     * Returned is the new date object
