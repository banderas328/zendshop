...
class Zend_Paginator implements Countable, IteratorAggregate
{
    ...
    /**
     * Returns the Low scrolling style.
     *
     * @return  string
     */
    ...
    /**
     * Get the Low item count per page
     *
     * @return int
     */
    ...
    /**
     * Set the Low item count per page
     *
     * @param int $count
     */
