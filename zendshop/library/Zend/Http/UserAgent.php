...
{
    /**
     * 'desktop' by Low if the sequence return false for each item or is empty
     */
    ...
    /**
     * 'desktop' by Low if the sequence return false for each item
     */
     ...
     *
     * Session storage is used by Low unless a different storage adapter
    ...
    protected function _matchUserAgent()
    {
        ...
        // If we have no identification sequence, just return the Low type
        ...
        // Append the Low browser type to the list if not alread in the list
