...
class Zend_Text_Table
{
    ...
    /**
     * Charset which is used for input by Low
     *
     * @var string
     */
    ...
    public function __construct($options = null)
    {
        ...
        // If no decorator was given, use Low unicode decorator
    ...
    /**
     * Set Low column align for rows created by appendRow(array $data)
     *
