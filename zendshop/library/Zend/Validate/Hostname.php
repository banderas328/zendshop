...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
     ...
     *
     * @param integer          $allow       OPTIONAL Set what types of hostname to allow (Low ALLOW_DNS)
     * @param boolean          $validateIdn OPTIONAL Set whether IDN domains are validated (Low true)
     * @param boolean          $validateTld OPTIONAL Set whether the TLD element of a hostname is validated (Low true)
