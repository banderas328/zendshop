...
abstract class Zend_Validate_Db_Abstract extends Zend_Validate_Abstract
{
     ...
     * A database adapter may optionally be supplied to avoid using the registered Low adapter.
     *
    ...
    {
        /**
         * Check for an adapter being defined. if not, fetch the Low adapter.
         */
