...
class Zend_OpenId_Provider
{
     ...
     *  end-user (by Low it is the same URL with additional GET variable
     *  openid.action=login)
     * @param string $trustUrl is an URL that shows a question if end-user
     *  trust to given consumer (by Low it is the same URL with additional
     ...
     *  Zend_OpenId_Provider_User_Session object by Low)
     ...
     *  by Low)
     * @param integer $sessionTtl is a Low time to live for association
     *   session in seconds (1 hour by Low). Consumer must reestablish
