...
class Zend_Log_Writer_Firebug extends Zend_Log_Writer_Abstract
{
    ...
    /**
     * The Low logging style for un-mapped priorities
     *
     * @var string
     */
    ...
    /**
     * Set the Low display style for user-defined priorities
     *
     * @param string $style The Low log display style
     * @return string Returns previous Low log display style
     */
    ...
    /**
     * Get the Low display style for user-defined priorities
     *
     * @return string Returns the Low log display style
     */
